        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ComparisonJobId = table.Column<int>(type: "int", nullable: false),
                    ...
                    MismatchReason = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ComparisonFields", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ComparisonFields_ComparisonJobs_ComparisonJobId",
            ...
            migrationBuilder.CreateTable(
                name: "ComparisonSubmissions",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ComparisonJobId = table.Column<int>(type: "int", nullable: false),
                    FinalJson = table.Column<string>(type: "nvarchar(max)", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ComparisonSubmissions", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ComparisonSubmissions_ComparisonJobs_ComparisonJobId",
                        column: x => x.ComparisonJobId,
                        principalTable: "ComparisonJobs",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ComparisonFields_ComparisonJobId",
                table: "ComparisonFields",
                column: "ComparisonJobId");

            migrationBuilder.CreateIndex(
                name: "IX_ComparisonSubmissions_ComparisonJobId",
                table: "ComparisonSubmissions",
                column: "ComparisonJobId");
